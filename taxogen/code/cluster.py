...
def run_clustering(full_data, doc_id_file, filter_keyword_file, n_cluster, parent_direcotry, parent_description,
    ...
    """
    :param full_data:
        full_data.documents: input_dir + 'papers.txt'
        full_data.embeddings: node_dir + 'embeddings.txt'
    :param doc_id_file: node_dir + 'doc_ids.txt'
    :param filter_keyword_file: node_dir + 'seed_keywords.txt'
    :param n_cluster:
    :param parent_direcotry: node_dir
    :param parent_description: parent
    :param cluster_keyword_file: node_dir + 'cluster_keywords.txt'
    :param hierarchy_file: node_dir + 'hierarchy.txt'
    :param doc_membership_file: node_dir + 'paper_cluster.txt'
    :return:
    """
