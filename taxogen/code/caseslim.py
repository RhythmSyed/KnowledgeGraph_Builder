...
def read_data(label_f, link_f):
    ...
    :return:
        ...
        freq_data:
            key: doc_id,
            value: a dict (key: phrase, value: phrase count)
...
def run_caseolap(cells, freq_data, target_phs, o_file, verbose=3, top_k=200):
    ...
    :param freq_data:
        key: doc_id,
        value: a dict (key: phrase, value: phrase count)
    :param target_phs: A set of clustered keywords
    :param o_file: node_dir + 'caseolap.txt'
    :param verbose:
    :param top_k:
    :return:
    """
...
def main_caseolap(link_f, cell_f, token_f, output_f):
    ...
    :param link_f: input_dir + 'keyword_cnt.txt'
    :param cell_f: node_dir + 'paper_cluster.txt'
    :param token_f: node_dir + 'cluster_keywords.txt'
    :param output_f: node_dir + 'caseolap.txt'
    :return:
    """
